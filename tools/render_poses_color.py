...
if __name__ == '__main__':
    ...
    root = '/home/yuxiang/Projects/Deep_Pose/data/LOV/data/0038/'
    outdir = '/home/yuxiang/Projects/YCB_Video_toolbox/data/0038/'
    num_images = 3466
    is_show = 0
    ...
    for i in perm:
        ...
        synthesizer_.render_poses_color_python(int(num), int(channel), int(width), int(height), parameters, im_syn, qt)
