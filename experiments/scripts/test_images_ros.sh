...
#time ./ros/test_images.py --gpu 0 \
#  --network vgg16_convs \
#  --model output/lov/lov_trainval/vgg16_fcn_color_single_frame_2d_pose_add_lov_iter_60000.ckpt \
#  --imdb lov_keyframe \
...
#time ./ros/test_images.py --gpu 0 \
#  --network vgg16_convs \
#  --model output/ycb/ycb_trainval/vgg16_fcn_color_single_frame_2d_pose_add_ycb_iter_20000.ckpt \
#  --imdb ycb_trainval \
