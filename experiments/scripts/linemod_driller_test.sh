...
#  --network vgg16_convs \
#  --model output/linemod/linemod_driller_train/vgg16_fcn_color_single_frame_linemod_driller_iter_40000.ckpt \
...
time ./tools/test_net.py --gpu 0 \
  --network vgg16_convs \
  --model output/linemod/linemod_driller_train_few/vgg16_fcn_color_single_frame_pose_linemod_driller_iter_80000.ckpt \
