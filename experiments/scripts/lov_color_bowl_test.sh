...
LOG="experiments/logs/lov_color_bowl_test.txt.`date +'%Y-%m-%d_%H-%M-%S'`"
exec &> >(tee -a "$LOG")
...
time ./tools/test_net.py --gpu 0 \
  --network vgg16_convs \
  --model output/lov/lov_024_bowl_train/vgg16_fcn_color_single_frame_2d_pose_add_lov_bowl_iter_160000.ckpt \
  --imdb lov_single_024_bowl_train \
  --cfg experiments/cfgs/lov_color_bowl.yml \
