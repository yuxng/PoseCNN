...
#if [ -f $PWD/output/ycb/ycb_val/vgg16_fcn_color_single_frame_2d_ycb_iter_80000/segmentations.pkl ]
#then
#  rm $PWD/output/ycb/ycb_val/vgg16_fcn_color_single_frame_2d_ycb_iter_80000/segmentations.pkl
#fi
