...
LOG="experiments/logs/linemod_single_color_pose.txt.`date +'%Y-%m-%d_%H-%M-%S'`"
exec &> >(tee -a "$LOG")
...
#  --ckpt output/linemod/linemod_ape_train/vgg16_fcn_color_single_frame_linemod_ape_iter_20000.ckpt \
...
time ./tools/test_net.py --gpu 0 \
  --network vgg16_convs \
  --model output/linemod/linemod_ape_train/vgg16_fcn_color_single_frame_pose_linemod_ape_iter_20000.ckpt \
