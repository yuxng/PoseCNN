...
time ./tools/train_net.py --gpu 0 \
  ...
  --cfg experiments/cfgs/shapenet_scene_depth.yml \
  --iters 10000

if [ -f $PWD/output/shapenet_scene/shapenet_scene_val/vgg16_fcn_depth_multi_frame_shapenet_scene_iter_10000/segmentations.pkl ]
then
  rm $PWD/output/shapenet_scene/shapenet_scene_val/vgg16_fcn_depth_multi_frame_shapenet_scene_iter_10000/segmentations.pkl
fi
