    ...
    def setup(self):
        ...
        for i in range(self.num_steps):
            ...
            (self.feed('data')
                 ...
                 .conv(3, 3, 128, 1, 1, name='conv2_1', reuse=reuse, trainable=False)
                 .conv(3, 3, 128, 1, 1, name='conv2_2', reuse=reuse, trainable=False)
                 .max_pool(2, 2, 2, 2, name='pool2')
                 .conv(3, 3, 256, 1, 1, name='conv3_1', reuse=reuse, trainable=False)
                 .conv(3, 3, 256, 1, 1, name='conv3_2', reuse=reuse, trainable=False)
                 .conv(3, 3, 256, 1, 1, name='conv3_3', reuse=reuse, trainable=False)
                 .max_pool(2, 2, 2, 2, name='pool3')
                 .conv(3, 3, 512, 1, 1, name='conv4_1', reuse=reuse, trainable=False)
                 .conv(3, 3, 512, 1, 1, name='conv4_2', reuse=reuse, trainable=False)
                 .conv(3, 3, 512, 1, 1, name='conv4_3', reuse=reuse, trainable=False)
                 .max_pool(2, 2, 2, 2, name='pool4')
                 .conv(3, 3, 512, 1, 1, name='conv5_1', reuse=reuse, trainable=False)
                 .conv(3, 3, 512, 1, 1, name='conv5_2', reuse=reuse, trainable=False)
                 .conv(3, 3, 512, 1, 1, name='conv5_3', reuse=reuse, trainable=False)
                 .conv(1, 1, self.num_classes, 1, 1, name='score', reuse=reuse, trainable=False)
                 .deconv(32, 32, self.num_classes, 16, 16, name='score_up', reuse=reuse, trainable=False))
            ...
            (self.feed('score_up', 'state_2d')
                 ...
                 .conv(1, 1, self.num_classes, 1, 1, name='score_rnn', reuse=reuse))

            (self.feed('score_up', 'score_rnn')
                 .add(name='add')
