...
class resnet50(Network):
    ...
    def setup(self):
        ...
        (self.feed('res5b_relu', 
             ...
             .conv(1, 1, 64, 1, 1, name='score_res5c', c_i=2048)
             .deconv(int(32*self.scale), int(32*self.scale), 64, int(16*self.scale), int(16*self.scale), name='upscore', trainable=False)
